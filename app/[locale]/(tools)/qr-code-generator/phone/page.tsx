...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description:
        "Generate Telephone QR codes instantly with our free online QR code generator. Customize with colors, logos, and high-quality downloads.",
    keywords: [
      "QR Code Generator",
      "Free QR Code Maker",
      "Custom QR Code",
    ...
    openGraph: {
      ...
      description:
          "Easily generate and customize QR codes for telephone numbers. Ideal for sharing online content," +
    ...
    twitter: {
      ...
      description:
          "Generate custom QR codes online for free. Download high-quality QR codes for texts.",
