...
export const generateMetadata = async (
  ...
  return {
    ...
    openGraph: {
      title: `${t('tools.qrCodeGenerator.text.title')} | Free QR Code Generator`,
      description: t('tools.qrCodeGenerator.text.description'),
      url: `${url}/qr-code-generator/text`,
      siteName: appName,
      images: [
        {
    ...
    twitter: {
      ...
      title: t('tools.qrCodeGenerator.text.title'),
      description:
          t('tools.qrCodeGenerator.text.description'),
