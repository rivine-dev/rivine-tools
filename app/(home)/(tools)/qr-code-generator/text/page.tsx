...
export const generateMetadata = (): Metadata => {
  return {
    ...
    description:
        "Generate Text QR codes instantly with our free online QR code generator. Customize with colors, logos, and high-quality downloads.",
    keywords: [
      "QR Code Generator",
      "Free QR Code Maker",
      "Custom QR Code",
    ...
    openGraph: {
      ...
      description:
          "Easily generate and customize QR codes for texts. Ideal for sharing online content," +
